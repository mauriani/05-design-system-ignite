...
declare const ToastContainerRoot: _stitches_react_types_styled_component.StyledComponent<react.ForwardRefExoticComponent<Toast$1.ToastProps & react.RefAttributes<HTMLLIElement>>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
interface ToastProps extends ComponentProps<typeof ToastContainerRoot> {
    title: string;
    description: string;
}
...
interface TooltipProps extends ComponentProps<typeof TooltipBase.Root> {
...
declare const theme: string & {
    ...
    fontWeight: {
        regular: _stitches_react_types_theme.Token<"regular", string, "fontWeight", "">;
        medium: _stitches_react_types_theme.Token<"medium", string, "fontWeight", "">;
        bold: _stitches_react_types_theme.Token<"bold", string, "fontWeight", "">;
    };
    fonts: {
    ...
    lineHeight: {
        shorter: _stitches_react_types_theme.Token<"shorter", string, "lineHeight", "">;
        short: _stitches_react_types_theme.Token<"short", string, "lineHeight", "">;
        base: _stitches_react_types_theme.Token<"base", string, "lineHeight", "">;
        tall: _stitches_react_types_theme.Token<"tall", string, "lineHeight", "">;
    };
    radii: {
