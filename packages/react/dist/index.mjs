...
function Toast2(_a) {
  ...
  return /* @__PURE__ */ jsx5("div", { children: /* @__PURE__ */ jsxs4(ToastContainer, { children: [
    /* @__PURE__ */ jsxs4(ToastContainerRoot, __spreadProps(__spreadValues({ duration: 2500 }, props), { children: [
...
function Tooltip2(_a) {
  ...
  return /* @__PURE__ */ jsx6(TooltipProvider, { children: /* @__PURE__ */ jsxs5(TooltipRoot, __spreadProps(__spreadValues({}, props), { children: [
